...
func (p *ActivityModel) GetActivityList() (activityList []*Activity, err error) {
	sql := "select activity_id, activity_name, product_id, start_time, end_time, total, status, sec_speed, buy_limit from activity order by activity_id desc"
...
func (p *ActivityModel) ProductValid(ProductID int, total int) (valid bool, err error) {
	sql := "select product_id, product_name, total, status from product where product_id=?"
...
func (p *ActivityModel) CreateActivity(activity *Activity) (err error) {
	...
	sql := "insert into activity(activity_name, product_id, start_time, end_time, total, sec_speed, buy_limit, buy_rate)values(?,?,?,?,?,?,?,?)"
